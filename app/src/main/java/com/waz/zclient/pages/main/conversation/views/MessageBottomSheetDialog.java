...
public class MessageBottomSheetDialog extends BottomSheetDialog {
    ...
    public enum MessageAction {
        FORWARD(R.id.message_bottom_menu_item_forward, R.string.glyph__error, R.string.message_bottom_menu_action_forward),
        COPY(R.id.message_bottom_menu_item_copy, R.string.glyph__error, R.string.message_bottom_menu_action_copy),
        DELETE_LOCAL(R.id.message_bottom_menu_item_delete_local, R.string.glyph__trash, R.string.message_bottom_menu_action_delete_local),
        DELETE_GLOBAL(R.id.message_bottom_menu_item_delete_global, R.string.glyph__trash, R.string.message_bottom_menu_action_delete_global),
    ...
    private void addAction(ViewGroup root, final MessageAction action) {
        LinearLayout row = (LinearLayout) getLayoutInflater().inflate(R.layout.message__bottom__menu__row, null);
