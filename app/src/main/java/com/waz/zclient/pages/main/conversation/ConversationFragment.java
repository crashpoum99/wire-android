...
public class ConversationFragment extends BaseFragment<ConversationFragment.Container> implements ConversationStoreObserver,
    ...
    public boolean onItemLongClick(Message message) {
        BottomSheetDialog dialog = new MessageBottomSheetDialog(getContext(),
                                                                message,
                                                                new MessageBottomSheetDialog.Callback() {
                                                                    @Override
                                                                    public void onAction(MessageBottomSheetDialog.MessageAction action, Message message) {
    ...
    private void deleteMessage(final Message message, boolean forEveryone) {
        Dialog dialog = new AlertDialog.Builder(getContext())
            .setTitle(getResources().getQuantityString(R.plurals.conversation__action_mode__delete__dialog__title, 0))
            .setMessage(getResources().getQuantityString(R.plurals.conversation__action_mode__delete__dialog__message, 0))
            .setCancelable(true)
    ...
    private static final class ToolbarActionModeCallback  {
        ...
        public boolean onActionItemClicked(final ActionMode mode, MenuItem item) {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.action_fwd:
                    ...
                    message = null; //actionModeController.getSelectedMessages().iterator().next();
